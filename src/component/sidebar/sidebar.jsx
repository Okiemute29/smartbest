          ...
          <div className="aiz-side-nav-wrap">
            ...
            >
              ...
              <li className={`aiz-side-nav-item  ${showPos === 'pos' && 'mm-active'}`}>
                <a href="#" className="aiz-side-nav-link" onClick={() => setShowPos(prev => prev === 'pos' ? null : 'pos' )}>
                  ...
                  >
                    <path
                      ...
                      transform="translate(-2.26 -2.939)"
                      fill="#707070"
                    />
                    <rect
                      id="Rectangle_10"
                      ...
                      width="1.7"
                      height="10.552"
                      transform="translate(11.516 6.033)"
                      fill="#707070"
                    />
                    <rect
                      id="Rectangle_11"
                      ...
                      width="0.731"
                      height="10.552"
                      transform="translate(13.691 6.033)"
                      fill="#707070"
                    />
                    <path
                      id="Path_11"
                ...
                <ul className={`aiz-side-nav-list level-2 mm-collapse ${showPos === 'pos' && 'mm-show'}`}>
                ...
                <ul className="aiz-side-nav-list level-2 mm-collapse">
                  ...
                  <li className="aiz-side-nav-item">
                    <a
                      ...
                      className="aiz-side-nav-link"
                    >
                      <span className="aiz-side-nav-text">Earning History</span>
                    </a>
                  </li>
                  <li className="aiz-side-nav-item">
                    <a
              ...
              <li className="aiz-side-nav-item">
                <a href="#" className="aiz-side-nav-link">
                  ...
                  >
                    ...
                    <g
                      id="Group_23708"
                      data-name="Group 23708"
                      clipPath="url(#clip-path)"
                    >
                      <path
                        id="Subtraction_80"
                        data-name="Subtraction 80"
                ...
                <ul className="aiz-side-nav-list level-2 mm-collapse">
                  ...
                  <li className="aiz-side-nav-item">
                    <a
                      ...
                      className="aiz-side-nav-link"
                    >
                      <span className="aiz-side-nav-text">Refund Settings</span>
                    </a>
                  </li>
                </ul>
              </li>
                ...
                <a href="#" className="aiz-side-nav-link">
                  ...
                  >
                    <g
                      ...
                      transform="translate(30 -303)"
                    >
                      <path
                        id="Rectangle_16222"
                        data-name="Rectangle 16222"
                        d="M0,0H2A0,0,0,0,1,2,0V3A1,1,0,0,1,1,4H1A1,1,0,0,1,0,3V0A0,0,0,0,1,0,0Z"
                        transform="translate(-28 313)"
                        fill="#707070"
                      />
                      <path
                        id="Rectangle_16223"
                        data-name="Rectangle 16223"
                      ...
                      <path
                        id="Path_18923"
                        data-name="Path 18923"
                        d="M0,0,5-2.044V7.97L0,6Z"
                        transform="translate(-25 306)"
                        fill="#707070"
                      />
                      <path
                        id="Rectangle_16225"
                        data-name="Rectangle 16225"
                        d="M0,0H0A2,2,0,0,1,2,2V2A2,2,0,0,1,0,4H0A0,0,0,0,1,0,4V0A0,0,0,0,1,0,0Z"
                        transform="translate(-16 307)"
                        fill="#707070"
                      />
                      <rect
                        id="Rectangle_16224"
                        data-name="Rectangle 16224"
                        width={2}
                        height={12}
                        rx={1}
                ...
                <ul className="aiz-side-nav-list level-2 mm-collapse">
                  <li className="aiz-side-nav-item">
                    <a
                      ...
                      className="aiz-side-nav-link "
                    >
                      <span className="aiz-side-nav-text">Offers</span>
                    </a>
                  </li>
                  <li className="aiz-side-nav-item">
                    <a
                  ...
                  >
                    ...
                    >
                      <path
                        ...
                        transform="translate(-0.109 -79.554)"
                        fill="#707070"
                      />
                      <path
                        id="Path_28780"
                      ...
                      <path
                        ...
                        transform="translate(-100.909 -43.363)"
                        fill="#707070"
                      />
                      <path
                        id="Path_28782"
                        data-name="Path 28782"
                        ...
                        transform="translate(-233.799 -21.222)"
                        fill="#707070"
                      />
                    </g>
                  </svg>
                  <span className="aiz-side-nav-text">Blog</span>
                  <span className="aiz-side-nav-arrow" />
                </a>
                <ul className="aiz-side-nav-list level-2 mm-collapse">
                  <li className="aiz-side-nav-item">
                    <a
                      ...
                      className="aiz-side-nav-link "
                    >
                      <span className="aiz-side-nav-text">All Blogs</span>
                    </a>
                  </li>
                  <li className="aiz-side-nav-item">
                    <a
                      ...
                      className="aiz-side-nav-link "
                    >
                      <span className="aiz-side-nav-text">Blog Categories</span>
                    </a>
                  </li>
                </ul>
              </li>
              ...
              <li className="aiz-side-nav-item">
                ...
                >
                  ...
                  >
                    <g
                      id="Group_23439"
                      data-name="Group 23439"
                      transform="translate(12740.499 6159.76)"
                    >
                      <path
                        id="Path_28783"
                        ...
                        transform="translate(-12932.919 -6159.76)"
                        fill="#707070"
                      />
                      <rect
                        id="Rectangle_17258"
                        data-name="Rectangle 17258"
                        width="2.48"
                        height="2.875"
                        transform="translate(-12734.919 -6156.351)"
                        fill="#707070"
                      />
                      <path
                        id="Union_63"
                        ...
                        transform="translate(-12740 -6156.362)"
                        fill="#707070"
                        stroke="rgba(0,0,0,0)"
                        strokeMiterlimit={10}
                        strokeWidth={1}
                  ...
                  <span className="aiz-side-nav-text">Product Querries</span>
                </a>
              </li>
              {/* product query */}
              {/* Uploaded Files */}
              ...
              <li className="aiz-side-nav-item">
                ...
                >
                  ...
                  <span className="aiz-side-nav-text">Support chat</span>
                </a>
              </li>
              ...
              <li className="aiz-side-nav-item">
                <a href="#" className="aiz-side-nav-link">
                  ...
                  >
                    ...
                    <g
                      id="Group_23782"
                      data-name="Group 23782"
                      clipPath="url(#clip-path)"
                    >
                      <path
                        id="Path_27903"
                        data-name="Path 27903"
                        ...
                        transform="translate(-126.005)"
                        fill="#707070"
                      />
                      <path
                        id="Path_27904"
                        data-name="Path 27904"
                        ...
                        transform="translate(0 -228.87)"
                        fill="#707070"
                      />
                      <path
                        id="Path_27905"
                        data-name="Path 27905"
                        ...
                        transform="translate(-95.942 -195.483)"
                        fill="#707070"
                      />
                    </g>
                  </svg>
              ...
              <li className="aiz-side-nav-item">
                <a href="#" className="aiz-side-nav-link">
                  ...
                  >
                    ...
                    <g
                      id="Group_22519"
                      data-name="Group 22519"
                      clipPath="url(#clip-path)"
                    >
                      <path
                        id="Path_27921"
                        data-name="Path 27921"
                        ...
                        transform="translate(0 -106.65)"
                        fill="#707070"
                      />
                      <path
                        id="Path_27922"
                        data-name="Path 27922"
                        ...
                        transform="translate(-136.315 -51.21)"
                        fill="#707070"
                      />
                      <path
                        id="Path_27923"
                        data-name="Path 27923"
                        ...
                        transform="translate(-141.977 -6.057)"
                        fill="#707070"
                      />
                      <path
                        id="Path_27924"
                        data-name="Path 27924"
                        ...
                        transform="translate(-160.643 -237.121)"
                        fill="#707070"
                      />
                      <path
                        id="Path_27925"
                        data-name="Path 27925"
                        ...
                        transform="translate(-198.853 -190.153)"
                        fill="#707070"
                      />
                      <path
                        id="Path_27926"
                        data-name="Path 27926"
                      ...
                      <path
                        ...
                        transform="translate(-13.218 -53.507)"
                        fill="#707070"
                      />
                      <path
                        id="Path_27928"
                        data-name="Path 27928"
                ...
                <ul className="aiz-side-nav-list level-2 mm-collapse">
                  ...
                  <li className="aiz-side-nav-item">
                    <a
                      ...
                      className="aiz-side-nav-link"
                    >
                      <span className="aiz-side-nav-text">OTP Settings</span>
                    </a>
                  </li>
                  <li className="aiz-side-nav-item">
                    <a
                  ...
                  <li className="aiz-side-nav-item">
                    <a
                      ...
                      className="aiz-side-nav-link "
                    >
                      <span className="aiz-side-nav-text">Tax</span>
                    </a>
                  </li>
                </ul>
              </li>
                ...
                <a href="#" className="aiz-side-nav-link">
                  ...
                  >
                    <g
                      ...
                      transform="translate(30 -384)"
                    >
                      <rect
                        id="Rectangle_16229"
                        data-name="Rectangle 16229"
                        width={8}
                        height={8}
                        rx={4}
                ...
                <ul className="aiz-side-nav-list level-2 mm-collapse">
                  ...
                  <li className="aiz-side-nav-item">
                    <a
                      ...
                      className="aiz-side-nav-link "
                    >
                      <span className="aiz-side-nav-text">Roles</span>
                    </a>
                  </li>
                </ul>
              </li>
